...
| [`specs/01-configuration.md`](specs/01-configuration.md) | Config file format & validation | Pending |
...
| [`specs/05-formatting.md`](specs/05-formatting.md) | Message formatting & transforms | Pending |
